...
Name:           ros-galactic-turtlebot4-tutorials
Version:        0.1.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS turtlebot4_tutorials package

License:        Apache 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-galactic-turtlebot4-cpp-tutorials
Requires:       ros-galactic-turtlebot4-python-tutorials
Requires:       ros-galactic-ros-workspace
BuildRequires:  ros-galactic-ament-cmake
BuildRequires:  ros-galactic-turtlebot4-cpp-tutorials
BuildRequires:  ros-galactic-turtlebot4-python-tutorials
